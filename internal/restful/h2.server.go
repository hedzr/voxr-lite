...
type H2 struct {
	...
	onBuildRoutes func(mux *http.ServeMux) (err error)
}
...
func NewH2(cmd *cmdr.Command, args []string, stopCh, doneCh chan struct{}, port int, buildRoutes func(mux *http.ServeMux) (err error)) (err error) {
	...
	if err = d.buildRoutes(d.mux); err != nil {
		return
	}
...
func (d *H2) selectLocalCertDir() (dir string) {
...
func (d *H2) findLocalCertFiles() (certFile, keyFile string) {
...
func (d *H2) domains(topDomains ...string) (domainList []string) {
...
func (d *H2) checkAndEnableAutoCert() (tlsConfig *tls.Config) {
...
func (d *H2) enableGracefulShutdown(srv *http.Server, stopCh, doneCh chan struct{}) {
